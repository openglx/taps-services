 ...
 *  $Id: irc.c 33 2010-05-10 02:46:01Z openglx $
*/
...
#ifdef IRCD_PLEXUS
  DBCONF_STR(ServerSID, "37A",
    "Services Unique Identifier, only used on Hybrid7/Plexus protocol")
#endif
  { NULL }
};
...
#ifdef IRCD_PLEXUS
  irc_Init(IRCD_PLEXUS, ServerName, ServerDesc, ServerSID, stderr);
#else
