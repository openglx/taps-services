 ...
 *  $Id: operserv.c 33 2010-05-10 02:46:01Z openglx $
*/
...
SVS_Module mod_info =
{"operserv", "2.2", "operserv core module" };

/* Change Log
  2.2 - TAPS first revision
...
/* commands */
void os_ctcp_ping(IRC_User *s, IRC_User *t);
...
int mod_load(void)
{
  ...
  irc_AddUMsgEvent(osu.u, "\1PING", os_ctcp_ping);
